...
<div class="flex flex-wrap gap-4">
  <div class="border border-gray-200 rounded-md p-4 shadow-sm bg-white text-lg font-semibold text-gray-700">
    Ethics Protocol
  </div>
  <div class="border border-gray-200 rounded-md p-4 shadow-sm bg-white text-lg font-semibold text-gray-700">
  ...
  <div class="border border-gray-200 rounded-md p-4 shadow-sm bg-white text-lg font-semibold text-gray-700">
    Any other Document
        ...
        <div class="priority-container">
          <label for="priorityInput" class="font-semibold mb-2">
