  ...
  <div class="flex-auto px-4 lg:px-10 py-10 pt-0">
    <form on:submit|preventDefault={handleSubmit}>
      ...
      <div class="flex flex-wrap mb-6">
        <div class="w-full lg:w-1/4 px-4 mb-6 lg:mb-0">
          <div class="relative w-full">
            ...
            <label class="block uppercase text-gray-600 text-xs font-bold mb-2">Ethics Protocol</label>
        ...
        <div class="w-full lg:w-1/4 px-4 mb-6 lg:mb-0">
          <div class="relative w-full">
            <!-- svelte-ignore a11y-label-has-associated-control -->
            <label class="block uppercase text-gray-600 text-xs font-bold mb-2">Specific Data Elements</label>
            <input type="file" class="hidden" />
          </div>
        </div>
        <div class="w-full lg:w-1/4 px-4 mb-6 lg:mb-0">
          <div class="relative w-full">
            <!-- svelte-ignore a11y-label-has-associated-control -->
            <label class="block uppercase text-gray-600 text-xs font-bold mb-2">Institution Approval</label>
            <input type="file" class="hidden" />
          </div>
        </div>
        <div class="w-full lg:w-1/4 px-4 mb-6 lg:mb-0">
          <div class="relative w-full">
            <!-- svelte-ignore a11y-label-has-associated-control -->
            <label class="block uppercase text-gray-600 text-xs font-bold mb-2">NACOSTI Approval</label>
            <input type="file" class="hidden" />
          </div>
        </div>
        <div class="w-full lg:w-1/4 px-4 mb-6 lg:mb-0">
          <div class="relative w-full">
            <!-- svelte-ignore a11y-label-has-associated-control -->
            <label class="block uppercase text-gray-600 text-xs font-bold mb-2">Study Protocol</label>
            <input type="file" class="hidden" />
          </div>
        </div>
        <div class="w-full lg:w-1/4 px-4 mb-6 lg:mb-0">
          <div class="relative w-full">
            <!-- svelte-ignore a11y-label-has-associated-control -->
            <label class="block uppercase text-gray-600 text-xs font-bold mb-2">Any other Document</label>
            <input type="file" class="hidden" />
          </div>
        </div>
      </div>
      ...
      <div class="flex flex-col items-center p-8 bg-gradient-to-r from-yellow-200 to-blue-300 rounded-lg shadow-lg max-w-lg mx-auto">
        ...
        <input type="file" id="fileInput" multiple on:change={handleFileChange} class="hidden" />
