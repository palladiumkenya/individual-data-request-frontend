      ...
      Array.from(files).forEach((file) => {
        ...
        reader.onload = function (e) {
          ...
          deleteButton.className =
            'bg-gradient-to-r from-blue-500 to-blue-700 text-white px-4 py-2 rounded-lg transition-transform hover:scale-105';
...
<!-- Data Request Form -->
<div
  class="relative flex flex-col min-w-full mb-9 shadow-lg rounded-lg bg-gray-100 border-0"
>
  <div class="rounded-t bg-white px-6 py-6 mb-0">
    <div class="text-center flex justify-between">
      <h6 class="text-gray-700 text-xl font-bold">Request For Data</h6>
      <button
        class="bg-red-400 text-white font-bold uppercase text-xs px-4 py-2 rounded shadow hover:shadow-md outline-none focus:outline-none mr-1 transition-all duration-150"
        type="button"
      >
        Settings
      </button>
    ...
    <form on:submit|preventDefault={handleSubmit}>
      <div class="flex flex-wrap mb-6">
        <div class="w-full lg:w-3/5 pr-4 mb-6 lg:mb-0">
          ...
          <textarea
            placeholder="Enter Description of data required here..."
        ...
        <div class="w-full lg:w-2/5">
          ...
          <div
            id="textPreview"
            class="bg-gradient-to-r from-yellow-200 to-blue-300 p-4 rounded-lg shadow-md whitespace-pre-wrap"
          >
            {textInput}
          </div>
        </div>
      ...
      <div class="flex flex-wrap mb-6">
        <div class="w-full lg:w-1/4 px-4 mb-6 lg:mb-8">
          <div class="relative w-full">
            <div
              class="bg-blue-500 text-white text-center p-2 rounded-lg transition-all duration-300 hover:bg-gradient-to-r hover:from-blue-400 hover:to-blue-600"
            >
        ...
        <div class="w-full lg:w-1/4 px-4 mb-6 lg:mb-0">
          <div class="relative w-full">
            <div
              class="bg-blue-500 text-white text-center p-2 rounded-lg transition-all duration-300 hover:bg-gradient-to-r hover:from-blue-400 hover:to-sky-600"
            >
      ...
      <div
        class="flex flex-col items-center p-8 bg-gradient-to-r from-yellow-200 to-blue-300 rounded-lg shadow-lg max-w-lg mx-auto"
      >
        <label
          for="fileInput"
          class="cursor-pointer text-lg mb-4 px-4 py-2 bg-blue-500 text-white rounded-lg flex items-center gap-2 hover:bg-blue-600 transition-colors"
        >
        ...
        <div id="filePreview" class="w-full mt-4">
          {#if files.length > 0}
            {#each files as file}
              <div
                class="flex items-center justify-between mb-3 p-4 rounded-lg bg-white shadow-md transition-transform hover:translate-y-1 transition-shadow hover:shadow-lg"
              >
                <div>
                  ...
                  <p>
                    <a
                      ...
                      target="_blank"
                      class="text-blue-500">View Full Size</a
                    >
                  </p>
                </div>
                <button
