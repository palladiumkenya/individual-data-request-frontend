<script>
    ...
    import CardAnalystDetails from "./CardAnalystDetails.svelte";
    ...
    function handleSubmit(event) {
        ...
        loadingAdd = true
        fetch(`${env.API_ENDPOINT}/user/create_analyst`, {
            method: 'POST',
            body: JSON.stringify({
                "Email": analystEmail
            })
            ...
            <div class="px-6 py-6 border-t border-blueGray-200">
                <div class="flex flex-wrap bg-blueGray">
                    <div class="w-full lg:w-8/12 px-4">
                        <h5 class="text-blueGray-700 text-sm font-bold">Analysts</h5>

                        <div class="py-6 border-t border-blueGray-200">
                            <CardAnalystDetails analysts={data}/>
                        </div>
                    </div>
                    <div class="w-full lg:w-4/12">
                        <div>
                            <h5 class="text-blueGray-700 text-sm font-bold">Add New Analyst</h5>
