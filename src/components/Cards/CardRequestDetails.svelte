  ...
  onMount(async () => {
    try {
      const response = await fetch(
        'http://localhost:8080/internal_approval/926c96fc-66a7-440c-b19a-07416da5ffd2'
      );
        ...
        {#if data.data.Approved}
          <div class="flex flex-wrap">
            <div class="w-full px-4 flex-1">
              <button
                class="bg-emerald-500 w-full text-white active:bg-orange-600 font-bold uppercase text-xs px-4 py-2
