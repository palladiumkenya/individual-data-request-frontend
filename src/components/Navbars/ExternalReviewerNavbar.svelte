<script>
    // core components
    import ExternalReviewerDropdown from '../Dropdowns/ExternalReviewerDropdown.svelte';
  </script>
  ...
  >
    ...
    >
      ...
      >
        Individual Data Requests Platform: External Reviewer
      </a>
      <!-- Form -->
      <form
