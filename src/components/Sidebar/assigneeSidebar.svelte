<script>
    ...
    // core components
    import AssigneeDropdown from '../Dropdowns/assigneeDropdown.svelte';
          ...
          <li class="items-center">
            ...
            >
              <i
                ...
                class:text-opacity-75={location?.href?.includes('/assignee/dashboard')}
                class:text-blueGray-300={!location?.href?.includes('/assignee/dashboard')}
              ></i>
